...
3. **Manage your agent** — The [Dashboard](http://hermes-agent.dappnode:8080/dashboard) lets you view sessions, manage API keys, configure skills, set up scheduled tasks, and check logs.
